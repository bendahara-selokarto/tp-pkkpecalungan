...
use App\Domains\Wilayah\LiterasiWarga\Controllers\DesaLiterasiWargaController;
use App\Domains\Wilayah\LiterasiWarga\Controllers\KecamatanLiterasiWargaController;
use App\Domains\Wilayah\BkbKegiatan\Controllers\DesaBkbKegiatanController;
use App\Domains\Wilayah\BkbKegiatan\Controllers\KecamatanBkbKegiatanController;
use App\Domains\Wilayah\TutorKhusus\Controllers\DesaTutorKhususController;
use App\Domains\Wilayah\TutorKhusus\Controllers\KecamatanTutorKhususController;
use App\Domains\Wilayah\PelatihanKaderPokjaIi\Controllers\DesaPelatihanKaderPokjaIiController;
use App\Domains\Wilayah\PelatihanKaderPokjaIi\Controllers\KecamatanPelatihanKaderPokjaIiController;
use App\Domains\Wilayah\PraKoperasiUp2k\Controllers\DesaPraKoperasiUp2kController;
use App\Domains\Wilayah\PraKoperasiUp2k\Controllers\KecamatanPraKoperasiUp2kController;
...
use App\Domains\Wilayah\BukuKonsultasi\Controllers\BukuKonsultasiPrintController;
...
Route::middleware(['auth', 'role:super-admin'])
    ...
    ->group(function () {
        ...
        Route::delete('access-control/override', [AccessControlManagementController::class, 'rollbackOverride'])
            ->name('access-control.override.rollback');
...
Route::prefix('desa')
    ...
    ->group(function () {
        ...
        Route::get('buku-konsultasi/report/pdf', [BukuKonsultasiPrintController::class, 'printDesaReport'])->name('buku-konsultasi.report');
        ...
        Route::resource('literasi-warga', DesaLiterasiWargaController::class);
        ...
        Route::get('data-kegiatan-pkk-pokja-i/report/pdf', [CatatanKeluargaPrintController::class, 'printDesaDataKegiatanPkkPokjaIReport'])
            ->name('data-kegiatan-pkk-pokja-i.report');
        ...
        Route::get('catatan-keluarga/data-kegiatan-pkk-pokja-ii/report/pdf', [CatatanKeluargaPrintController::class, 'printDesaDataKegiatanPkkPokjaIiReport'])->name('catatan-keluarga.data-kegiatan-pkk-pokja-ii.report');
...
Route::prefix('kecamatan')
    ...
    ->group(function () {
        ...
        Route::get('buku-konsultasi/report/pdf', [BukuKonsultasiPrintController::class, 'printKecamatanReport'])->name('buku-konsultasi.report');
        ...
        Route::resource('literasi-warga', KecamatanLiterasiWargaController::class);
        ...
        Route::get('data-kegiatan-pkk-pokja-i/report/pdf', [CatatanKeluargaPrintController::class, 'printKecamatanDataKegiatanPkkPokjaIReport'])
            ->name('data-kegiatan-pkk-pokja-i.report');
        ...
        Route::get('catatan-keluarga/data-kegiatan-pkk-pokja-ii/report/pdf', [CatatanKeluargaPrintController::class, 'printKecamatanDataKegiatanPkkPokjaIiReport'])->name('catatan-keluarga.data-kegiatan-pkk-pokja-ii.report');
