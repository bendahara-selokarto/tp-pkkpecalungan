...
<head>
    <meta charset="UTF-8">
    <title>Catatan Data dan Kegiatan Warga TP PKK Kecamatan</title>
    <style>
...
<body>
    ...
    <div class="lampiran">LAMPIRAN 4.17b</div>
    <div class="title">CATATAN DATA DAN KEGIATAN WARGA</div>
    <div class="subtitle">TP PKK KECAMATAN TAHUN {{ $reportYear }}</div>
    ...
    <table class="main-table">
        <colgroup>
            ...
            @for ($i = 0; $i < 26; $i++)
                <col style="width: 28px;"> <!-- 9-34 -->
            @endfor
            <col style="width: 80px;"> <!-- 35: KET -->
        </colgroup>
        <thead>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="35" class="center">Data rekap belum tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
