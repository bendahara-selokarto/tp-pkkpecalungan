...
<body>
    ...
    <div class="title">DATA KELUARGA {{ $levelLabel }}</div>
    <div class="meta">
        ...
        <tbody>
            @forelse ($items as $index => $item)
                <tr>
                    ...
                    <td>{{ $item->kategori_keluarga }}</td>
                    <td class="center">{{ $item->jumlah_keluarga }}</td>
                    <td>{{ $item->keterangan ?: '-' }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="4" class="center">Data keluarga belum tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
