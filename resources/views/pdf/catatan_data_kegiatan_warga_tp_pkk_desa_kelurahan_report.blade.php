...
<head>
    <meta charset="UTF-8">
    <title>Catatan Data dan Kegiatan Warga TP PKK</title>
    <style>
...
<body>
    ...
    <div class="lampiran">LAMPIRAN 4.17a</div>
    <div class="title">CATATAN DATA DAN KEGIATAN WARGA TP PKK</div>
    <div class="subtitle">DESA/KELURAHAN TAHUN {{ $reportYear }}</div>
        ...
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td class="left">{{ $item['nama_dusun_lingkungan'] ?? '-' }}</td>
                    ...
                    <td class="center">{{ $item['tiga_buta'] ?? 0 }}</td>
