...
<head>
    <meta charset="UTF-8">
    <title>Rekapitulasi Catatan Data dan Kegiatan Warga Kelompok Dasa Wisma</title>
    <style>
...
<body>
    ...
    <div class="lampiran">LAMPIRAN 4.16a</div>
    <div class="title">REKAPITULASI CATATAN DATA DAN KEGIATAN WARGA KELOMPOK DASA WISMA</div>
        ...
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td class="left">{{ $item['nama_kepala_rumah_tangga'] }}</td>
            ...
            @empty
                <tr>
                    <td colspan="29" class="center">Data rekap belum tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
