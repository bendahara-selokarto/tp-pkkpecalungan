...
<head>
    <meta charset="UTF-8">
    <title>Rekapitulasi Data/Buku Catatan Ibu Hamil TP PKK Kecamatan</title>
    <style>
        ...
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td class="center">{{ $item['jumlah_rw'] ?? 0 }}</td>
            ...
            @empty
                <tr>
                    <td colspan="19" class="center">Data rekap belum tersedia.</td>
                </tr>
            @endforelse
            <tr>
                <td></td>
                ...
                <td class="center"><strong>{{ $totalsData['jumlah_rw'] ?? 0 }}</strong></td>
