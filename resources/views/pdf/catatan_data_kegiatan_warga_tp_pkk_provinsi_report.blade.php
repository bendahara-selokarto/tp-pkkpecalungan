...
<head>
    <meta charset="UTF-8">
    <title>Catatan Data dan Kegiatan Warga TP PKK Provinsi</title>
    <style>
...
<body>
    ...
    <div class="lampiran">LAMPIRAN 4.17d</div>
    <div class="title">CATATAN DATA DAN KEGIATAN WARGA</div>
    <div class="subtitle">TP PKK PROVINSI TAHUN {{ $reportYear }}</div>
    ...
    <table class="main-table">
        <colgroup>
            ...
            <col style="width: 100px;"> <!-- 2: KAB/KOTA -->
            <col style="width: 35px;"> <!-- 3 -->
            <col style="width: 35px;"> <!-- 4 -->
            <col style="width: 35px;"> <!-- 5 -->
            <col style="width: 35px;"> <!-- 6 -->
            <col style="width: 35px;"> <!-- 7 -->
            <col style="width: 35px;"> <!-- 8 -->
            <col style="width: 35px;"> <!-- 9 -->
            <col style="width: 35px;"> <!-- 10 -->
            @for ($i = 0; $i < 26; $i++)
                <col style="width: 28px;"> <!-- 11-36 -->
            @endfor
            <col style="width: 80px;"> <!-- 37: KET -->
        </colgroup>
        <thead>
            <tr class="header-group">
                <th rowspan="3">NO</th>
                <th rowspan="3">NAMA KAB/KOTA</th>
                <th rowspan="3">JML KEC</th>
                <th rowspan="3">JUML DESA/KEL</th>
                <th rowspan="3">JUML DUSUN/LINGK</th>
        ...
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td class="left">{{ $item['nama_kab_kota'] ?? '-' }}</td>
                    <td class="center">{{ $item['jml_kecamatan'] ?? 0 }}</td>
            ...
            @empty
                <tr>
                    <td colspan="37" class="center">Data rekap belum tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
