                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="flex-1 overflow-y-auto p-4 space-y-5">
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('super-admin.areas.index') }}" :class="sidebarCollapsed ? 'justify-center' : ''" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('super-admin.areas.*') ? $activeLinkClass : $idleLinkClass }}" title="Manajemen Wilayah">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <span x-show="!sidebarCollapsed">Manajemen Wilayah</span>
                            </a>
                            @endrole
                        </div>
