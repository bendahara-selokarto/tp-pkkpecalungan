  ...
  const rawGroups = [
    {
      ...
      items: [
        ...
        { href: `/${scope}/buku-notulen-rapat?book_group=sekretaris-tpk`, label: 'Buku Notulen Rapat' },
        ...
        { href: `/${scope}/buku-daftar-hadir?book_group=sekretaris-tpk`, label: 'Buku Daftar Hadir' },
