  ...
  const rawGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${scope}/buku-kliping`, label: 'Kliping' },
        { href: `/${scope}/paar`, label: 'Data PAAR' },
        // Item tambahan khusus desa
        { href: `/${scope}/buku-daftar-hadir`, label: 'Buku Daftar Hadir' },
        { href: `/${scope}/buku-tamu`, label: 'Buku Tamu' },
        { href: `/${scope}/buku-agenda-sk`, label: 'Buku Agenda SK' },
        { href: `/${scope}/literasi-warga`, label: 'Buku Literasi Warga' },
      ],
    },
    {
      key: 'pokja-ii',
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${scope}/foto-kegiatan`, label: 'Unggah Foto Kegiatan' },
        // Item tambahan khusus desa
        { href: `/${scope}/bkb-kegiatan`, label: 'Buku BKB' },
        { href: `/${scope}/literasi-warga`, label: 'Buku Literasi Warga' },
        { href: `/${scope}/tutor-khusus`, label: 'Buku Tutor Khusus' },
        { href: `/${scope}/koperasi`, label: 'Buku Koperasi' },
        { href: `/${scope}/kejar-paket`, label: 'Buku Kejar Paket' },
        { href: `/${scope}/taman-bacaan`, label: 'Buku Taman Bacaan' },
        { href: `/${scope}/kader-khusus`, label: 'Buku Kader Khusus Pokja II' },
        { href: `/${scope}/anggota-pokja`, label: 'Buku Anggota Pokja II' },
      ],
    },
    {
      key: 'pokja-iii',
      ...
      items: [
        ...
        { href: `/${scope}/buku-bantu-pangan/report/pdf`, label: 'Buku Bantu Pangan', external: true },
        { href: `/${scope}/data-industri-rumah-tangga`, label: 'Buku Bantu Jumlah Industri Rumah Tangga' },
        { href: `/${scope}/buku-konsultasi`, label: 'Buku Konsultasi' },
        { href: `/${scope}/buku-keuangan`, label: 'Buku Kas Pokja' },
        { href: `/${scope}/anggota-pokja`, label: 'Buku Susunan Pengurus Pokja' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${scope}/catatan-keluarga/buku-data-kegiatan-posyandu-pokja-iv/report/pdf`, label: 'Data Kegiatan Posyandu' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${scope}/anggota-pokja`, label: 'Buku Anggota Pokja IV' },
        { href: `/${scope}/bkb-kegiatan`, label: 'Buku BKB' },
      ],
    },
  ]
