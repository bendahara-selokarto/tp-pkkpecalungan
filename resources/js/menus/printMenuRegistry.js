  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${scope}/anggota-pokja`, label: 'Anggota Pokja I' },
        { href: `/${scope}/bkl`, label: 'Buku Kegiatan BKL' },
