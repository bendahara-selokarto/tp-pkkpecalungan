...
const deleteConfirmationMessage = 'Apakah Anda yakin ingin menghapus naskah pelaporan ini?'
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton
      ...
      :title="`Naskah Pelaporan Pilot Project Pokja IV ${props.scopeLabel}`"
      main
    />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Naskah</h3>
        <div class="flex items-center gap-2">
          <a
            :href="`${props.scopePrefix}/report/pdf`"
            target="_blank"
            rel="noopener"
        ...
        <table class="w-full min-w-[760px] text-sm">
          <thead class="border-b border-gray-200 dark:border-slate-700">
            <tr class="text-left text-gray-600 dark:text-gray-300">
              <th class="px-3 py-3 font-semibold">Judul Naskah</th>
              <th class="px-3 py-3 font-semibold text-center">Jumlah Lampiran</th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3 text-center text-gray-700 dark:text-gray-300">{{ report.attachments_count }}</td>
              <td class="px-3 py-3 text-gray-700 dark:text-gray-300">{{ report.updated_at || '-' }}</td>
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`${props.scopePrefix}/${report.id}`"
                  ...
                  <Link
                    :href="`${props.scopePrefix}/${report.id}/edit`"
