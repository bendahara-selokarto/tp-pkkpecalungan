...
const updatePerPage = (event) => {
  ...
  router.get('/desa/pra-koperasi-up2k', {
    ...props.filters,
    page: 1,
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/pra-koperasi-up2k/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Pra Koperasi/UP2K Desa" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          <a
            href="/desa/pra-koperasi-up2k/report/pdf/chart"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/pra-koperasi-up2k/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/pra-koperasi-up2k/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/pra-koperasi-up2k/${item.id}/edit`"
