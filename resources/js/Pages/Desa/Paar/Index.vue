...
const updatePerPage = (event) => {
  ...
  router.get('/desa/paar', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/paar/${deletingId.value}`, {
    onFinish: () => {
