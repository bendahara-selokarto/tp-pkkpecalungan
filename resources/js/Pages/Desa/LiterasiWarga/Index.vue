...
const updatePerPage = (event) => {
  ...
  router.get('/desa/literasi-warga', {
    ...props.filters,
    page: 1,
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/literasi-warga/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiBookOpenVariant" title="Data Literasi Warga Desa" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Data Literasi Warga</h3>
        <Link
          href="/desa/literasi-warga/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/literasi-warga/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/literasi-warga/${item.id}/edit`"
