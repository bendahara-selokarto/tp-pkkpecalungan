...
const confirmDelete = () => {
  ...
  router.delete(`/desa/bkb-kegiatan/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Data Kegiatan BKB Desa" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Data Kegiatan BKB</h3>
        <Link
          href="/desa/bkb-kegiatan/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/bkb-kegiatan/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/bkb-kegiatan/${item.id}/edit`"
