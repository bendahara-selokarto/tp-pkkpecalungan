...
const confirmDelete = () => {
  ...
  router.delete(`/desa/inventaris/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiPackageVariantClosed" title="Buku Inventaris Desa" main />
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  ...
                  <Link
                    :href="`/desa/inventaris/${item.id}/edit`"
