...
const hapusAgenda = (id) => {
  if (!window.confirm('Apakah Anda yakin ingin menghapus agenda surat ini?')) {
    return
  }

  router.delete(`/desa/agenda-surat/${id}`)
}
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiEmailFastOutline" title="Agenda Surat Desa" main />
