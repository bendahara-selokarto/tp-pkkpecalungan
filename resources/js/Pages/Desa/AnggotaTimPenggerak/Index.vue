...
const confirmDelete = () => {
  ...
  router.delete(`/desa/anggota-tim-penggerak/${deletingId.value}`, {
    onFinish: () => {
...
const updatePerPage = (event) => {
  ...
  router.get('/desa/anggota-tim-penggerak', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
    ...
    <CardBox>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[900px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in anggotaTimPenggeraks.data"
              :key="item.id"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/anggota-tim-penggerak/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/anggota-tim-penggerak/${item.id}/edit`"
            ...
            <tr v-if="anggotaTimPenggeraks.data.length === 0">
      ...
      <PaginationBar
        :links="anggotaTimPenggeraks.links"
        :from="anggotaTimPenggeraks.from"
        :to="anggotaTimPenggeraks.to"
        :total="anggotaTimPenggeraks.total"
      />
    </CardBox>
