...
const confirmDelete = () => {
  ...
  router.delete(`/desa/tutor-khusus/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Data Tutor Khusus Desa" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Data Tutor Khusus</h3>
        <Link
          href="/desa/tutor-khusus/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/tutor-khusus/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/tutor-khusus/${item.id}/edit`"
