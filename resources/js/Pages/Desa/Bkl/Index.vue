...
const confirmDelete = () => {
  ...
  router.delete(`/desa/bkl/${deletingId.value}`, {
    onFinish: () => {
...
const updatePerPage = (event) => {
  ...
  router.get('/desa/bkl', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
