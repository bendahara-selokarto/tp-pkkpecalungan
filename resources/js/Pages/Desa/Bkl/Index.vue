...
const hapusBkl = (id) => {
  if (!window.confirm('Apakah Anda yakin ingin menghapus data BKL ini?')) {
    return
  }

  router.delete(`/desa/bkl/${id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="BKL Desa" main />
