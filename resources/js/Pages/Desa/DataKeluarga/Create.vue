...
const form = useForm({
  kategori_keluarga: props.kategoriOptions[0] ?? '',
  jumlah_keluarga: 0,
  keterangan: '',
})

const submit = () => {
  form.post('/desa/data-keluarga')
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Tambah Data Keluarga Desa" main />
