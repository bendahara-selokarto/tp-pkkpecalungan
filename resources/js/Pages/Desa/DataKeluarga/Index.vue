...
const updatePerPage = (event) => {
  ...
  router.get('/desa/data-keluarga', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/data-keluarga/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Data Keluarga Desa" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/data-keluarga/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/data-keluarga/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/data-keluarga/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/data-keluarga/${item.id}/edit`"
