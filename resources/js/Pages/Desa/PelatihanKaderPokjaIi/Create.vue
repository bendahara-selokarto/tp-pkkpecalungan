...
const form = useForm({
  kategori_pelatihan: kategoriOptions[0]?.value ?? '',
  jumlah_kader: '',
  keterangan: '',
})

const submit = () => {
  form.post('/desa/pelatihan-kader-pokja-ii')
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Tambah Pelatihan Kader Pokja II Desa" main />
