...
const submit = () => {
  form.put(`/desa/pelatihan-kader-pokja-ii/${props.pelatihanKader.id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Edit Pelatihan Kader Pokja II Desa" main />
