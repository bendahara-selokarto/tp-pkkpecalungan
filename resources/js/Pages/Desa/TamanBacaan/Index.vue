...
const updatePerPage = (event) => {
  ...
  router.get('/desa/taman-bacaan', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/taman-bacaan/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiStore" title="Data Isian Taman Bacaan/Perpustakaan Desa" main />
