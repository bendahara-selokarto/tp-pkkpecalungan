...
const deleteConfirmationMessage = 'Apakah Anda yakin ingin menghapus data notulen rapat ini?'
...
const updatePerPage = (event) => {
  ...
  router.get('/desa/buku-notulen-rapat', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/buku-notulen-rapat/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiNotebookEditOutline" title="Buku Notulen Rapat Desa" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Notulen Rapat</h3>
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/buku-notulen-rapat/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/buku-notulen-rapat/create"
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[760px] text-sm">
          ...
          <tbody>
            ...
            >
              <td class="px-3 py-3 text-gray-700 dark:text-gray-300">{{ formatDate(item.entry_date) }}</td>
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/buku-notulen-rapat/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/buku-notulen-rapat/${item.id}/edit`"
