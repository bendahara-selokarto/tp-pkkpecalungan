...
const hapusDataPemanfaatan = (id) => {
  ...
  router.delete(`/desa/data-pemanfaatan-tanah-pekarangan-hatinya-pkk/${id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Data Pemanfaatan Tanah Pekarangan/HATINYA PKK Desa" main />
