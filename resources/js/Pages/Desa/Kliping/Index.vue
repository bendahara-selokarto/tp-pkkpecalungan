...
const updatePerPage = (event) => {
  ...
  router.get('/desa/buku-kliping', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/buku-kliping/${deletingId.value}`, {
    onFinish: () => {
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/buku-kliping/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/buku-kliping/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/buku-kliping/${item.id}/edit`"
