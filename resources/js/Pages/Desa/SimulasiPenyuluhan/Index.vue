...
const confirmDelete = () => {
  ...
  router.delete(`/desa/simulasi-penyuluhan/${deletingId.value}`, {
    onFinish: () => {
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          <a
            href="/desa/simulasi-penyuluhan/report/pdf/chart"
            target="_blank"
            rel="noopener"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/simulasi-penyuluhan/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/simulasi-penyuluhan/${item.id}/edit`"
