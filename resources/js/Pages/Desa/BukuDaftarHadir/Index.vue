...
const updatePerPage = (event) => {
  ...
  router.get('/desa/buku-daftar-hadir', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/buku-daftar-hadir/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiNotebookEditOutline" title="Buku Daftar Hadir Desa" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/buku-daftar-hadir/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/buku-daftar-hadir/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/buku-daftar-hadir/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/buku-daftar-hadir/${item.id}/edit`"
