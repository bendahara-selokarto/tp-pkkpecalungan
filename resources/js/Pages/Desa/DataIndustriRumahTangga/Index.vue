...
const updatePerPage = (event) => {
  ...
  router.get('/desa/data-industri-rumah-tangga', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/data-industri-rumah-tangga/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Buku Industri Rumah Tangga Desa" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/data-industri-rumah-tangga/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/data-industri-rumah-tangga/create"
        ...
        <table class="w-full min-w-[900px] text-sm">
          <thead class="border-b border-gray-200 dark:border-slate-700">
            <tr class="text-left text-gray-600 dark:text-gray-300">
              <th class="px-3 py-3 font-semibold">Kategori Jenis Industri Rumah Tangga</th>
              <th class="px-3 py-3 font-semibold">Komoditi yang Diusahakan</th>
              <th class="px-3 py-3 font-semibold text-center">Jumlah Komoditi yang Dikelola</th>
              <th class="px-3 py-3 font-semibold w-44">Aksi</th>
            </tr>
          </thead>
          <tbody>
            <tr
              v-for="item in props.dataIndustriRumahTanggaItems.data"
              :key="item.id"
              class="border-b border-gray-100 align-top dark:border-slate-800"
            >
              <td class="px-3 py-3 text-gray-900 dark:text-gray-100">{{ item.kategori_jenis_industri }}</td>
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/data-industri-rumah-tangga/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/data-industri-rumah-tangga/${item.id}/edit`"
                  ...
                  <button
                    ...
                    @click="hapusDataIndustri(item.id)"
                  >
                    Hapus
                  </button>
                </div>
            ...
            <tr v-if="props.dataIndustriRumahTanggaItems.data.length === 0">
      ...
      <PaginationBar
        :links="dataIndustriRumahTanggaItems.links"
        :from="dataIndustriRumahTanggaItems.from"
        :to="dataIndustriRumahTanggaItems.to"
        :total="dataIndustriRumahTanggaItems.total"
      />
    </CardBox>
