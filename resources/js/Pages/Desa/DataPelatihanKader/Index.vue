...
const updatePerPage = (event) => {
  ...
  router.get('/desa/data-pelatihan-kader', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/data-pelatihan-kader/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Data Pelatihan Kader Desa" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/data-pelatihan-kader/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/desa/data-pelatihan-kader/create"
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[1100px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in props.dataPelatihanKaderItems.data"
              :key="item.id"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/desa/data-pelatihan-kader/${item.id}`"
                  ...
                  <Link
                    :href="`/desa/data-pelatihan-kader/${item.id}/edit`"
            ...
            <tr v-if="props.dataPelatihanKaderItems.data.length === 0">
      ...
      <PaginationBar
        :links="dataPelatihanKaderItems.links"
        :from="dataPelatihanKaderItems.from"
        :to="dataPelatihanKaderItems.to"
        :total="dataPelatihanKaderItems.total"
      />
    </CardBox>
