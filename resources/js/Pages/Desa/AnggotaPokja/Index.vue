...
const confirmDelete = () => {
  ...
  router.delete(`/desa/anggota-pokja/${deletingId.value}`, {
    onFinish: () => {
...
const updatePerPage = (event) => {
  ...
  router.get('/desa/anggota-pokja', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Buku Anggota Pokja Desa" main />
