...
const deleteConfirmationMessage = 'Apakah Anda yakin ingin menghapus data buku tamu ini?'
...
const updatePerPage = (event) => {
  ...
  router.get('/desa/buku-tamu', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/desa/buku-tamu/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiNotebookEditOutline" title="Buku Tamu Desa" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Buku Tamu</h3>
        <div class="flex items-center gap-2">
          ...
          <a
            href="/desa/buku-tamu/report/pdf"
            target="_blank"
            rel="noopener"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  ...
                  <Link
                    :href="`/desa/buku-tamu/${item.id}/edit`"
