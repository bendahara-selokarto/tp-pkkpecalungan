...
const confirmDelete = () => {
  ...
  router.delete(`/desa/posyandu/${deletingId.value}`, {
    onFinish: () => {
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          <a
            href="/desa/posyandu/report/pdf/chart"
            target="_blank"
            rel="noopener"
...
<div class="overflow-x-auto">
        <table class="w-full min-w-[1400px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in props.posyanduItems.data"
              :key="item.id"
            ...
            <tr v-if="props.posyanduItems.data.length === 0">
      ...
      <PaginationBar
        :links="props.posyanduItems.links"
        :from="props.posyanduItems.from"
        :to="props.posyanduItems.to"
        :total="props.posyanduItems.total"
      />
    </CardBox>
