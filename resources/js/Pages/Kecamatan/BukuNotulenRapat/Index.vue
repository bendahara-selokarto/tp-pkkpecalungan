...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/buku-notulen-rapat', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/buku-notulen-rapat/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiNotebookEditOutline" title="Buku Notulen Rapat" main />
        ...
        <table class="w-full min-w-[760px] text-sm">
          <thead class="border-b border-gray-200 dark:border-slate-700">
            <tr class="text-left text-gray-600 dark:text-gray-300">
              ...
              <th class="px-3 py-3 font-semibold">Judul Notulen</th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/buku-notulen-rapat/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/buku-notulen-rapat/${item.id}/edit`"
