...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/data-pemanfaatan-tanah-pekarangan-hatinya-pkk', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/kecamatan/data-pemanfaatan-tanah-pekarangan-hatinya-pkk/report/pdf/chart"
            target="_blank"
            rel="noopener"
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[900px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in props.dataPemanfaatanTanahPekaranganHatinyaPkkItems.data"
              :key="item.id"
      ...
      <PaginationBar
        :links="dataPemanfaatanTanahPekaranganHatinyaPkkItems.links"
        :from="dataPemanfaatanTanahPekaranganHatinyaPkkItems.from"
        :to="dataPemanfaatanTanahPekaranganHatinyaPkkItems.to"
        :total="dataPemanfaatanTanahPekaranganHatinyaPkkItems.total"
      />
    </CardBox>
