...
const form = useForm({
  kategori_pemanfaatan: props.kategoriPemanfaatanOptions[0] ?? '',
  jumlah_kk_memanfaatkan: 0,
  keterangan: '',
})

const submit = () => {
  form.post('/kecamatan/data-pemanfaatan-tanah-pekarangan-hatinya-pkk')
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Tambah Data Pemanfaatan Tanah Pekarangan/HATINYA PKK Kecamatan" main />
