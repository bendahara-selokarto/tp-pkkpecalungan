...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/warung-pkk', {
    ...props.filters,
    page: 1,
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/warung-pkk/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiStore" title="Data aset (sarana) desa/kelurahan (Kecamatan)" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          <a
            href="/kecamatan/warung-pkk/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/kecamatan/warung-pkk/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/warung-pkk/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/warung-pkk/${item.id}/edit`"
