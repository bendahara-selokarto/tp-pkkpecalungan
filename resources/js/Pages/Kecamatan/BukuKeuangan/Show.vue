...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiHandHeart" title="Detail Buku Keuangan Kecamatan" main />
    ...
    <CardBox class="max-w-3xl space-y-4">
      ...
      <div class="flex items-center justify-end gap-2">
        <Link href="/kecamatan/buku-keuangan" class="inline-flex rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800">
          Kembali
        </Link>
        <Link :href="`/kecamatan/buku-keuangan/${props.entry.id}/edit`" class="inline-flex rounded-md bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">
          Edit
        </Link>
      </div>
    </CardBox>
