...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/buku-keuangan/${deletingId.value}`, {
    onFinish: () => {
...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/buku-keuangan', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiHandHeart" title="Buku Keuangan Kecamatan" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            href="/kecamatan/buku-keuangan/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/kecamatan/buku-keuangan/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/buku-keuangan/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/buku-keuangan/${item.id}/edit`"
