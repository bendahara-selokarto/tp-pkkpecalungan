...
const form = useForm({
  jenis_surat: props.agendaSurat.jenis_surat ?? 'masuk',
  tanggal_terima: props.agendaSurat.tanggal_terima ?? '',
  tanggal_surat: props.agendaSurat.tanggal_surat ?? '',
  nomor_surat: props.agendaSurat.nomor_surat ?? '',
  asal_surat: props.agendaSurat.asal_surat ?? '',
  dari: props.agendaSurat.dari ?? '',
  kepada: props.agendaSurat.kepada ?? '',
  perihal: props.agendaSurat.perihal ?? '',
  lampiran: props.agendaSurat.lampiran ?? '',
...
const submit = () => {
  form.put(`/kecamatan/agenda-surat/${props.agendaSurat.id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiEmailEditOutline" title="Edit Agenda Surat Kecamatan" main />
