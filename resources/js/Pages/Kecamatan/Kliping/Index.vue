...
const deleteConfirmationMessage = 'Apakah Anda yakin ingin menghapus data Buku Kliping ini?'
...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/buku-kliping', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/buku-kliping/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiNotebookEditOutline" title="Buku Kliping" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Buku Kliping</h3>
        <div class="flex items-center gap-2">
          ...
          <a
            href="/kecamatan/buku-kliping/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/kecamatan/buku-kliping/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/buku-kliping/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/buku-kliping/${item.id}/edit`"
            ...
            <tr v-if="items.data.length === 0">
              <td colspan="4" class="px-3 py-6 text-center text-sm text-gray-500 dark:text-gray-400">
                Data Buku Kliping belum tersedia.
              </td>
            </tr>
          </tbody>
        </table>
