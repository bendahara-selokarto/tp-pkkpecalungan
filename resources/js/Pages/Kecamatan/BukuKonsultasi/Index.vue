...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/buku-konsultasi/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountVoice" title="Buku Konsultasi Kecamatan" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Konsultasi</h3>
        <Link
          href="/kecamatan/buku-konsultasi/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/buku-konsultasi/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/buku-konsultasi/${item.id}/edit`"
