...
const submit = () => {
  form.put(`/kecamatan/simulasi-penyuluhan/${props.simulasiPenyuluhan.id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Edit Kelompok Simulasi dan Penyuluhan (Kecamatan)" main />
