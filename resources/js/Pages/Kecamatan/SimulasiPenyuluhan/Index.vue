...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/simulasi-penyuluhan', {
    ...props.filters,
    page: 1,
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Kelompok Simulasi dan Penyuluhan (Kecamatan)" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          <a
            href="/kecamatan/simulasi-penyuluhan/report/pdf/chart"
            target="_blank"
            rel="noopener"
...
<div class="overflow-x-auto">
        <table class="w-full min-w-[1020px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in props.simulasiPenyuluhanItems.data"
              :key="item.id"
            ...
            <tr v-if="props.simulasiPenyuluhanItems.data.length === 0">
      ...
      <PaginationBar
        :links="props.simulasiPenyuluhanItems.links"
        :from="props.simulasiPenyuluhanItems.from"
        :to="props.simulasiPenyuluhanItems.to"
        :total="props.simulasiPenyuluhanItems.total"
      />
    </CardBox>
