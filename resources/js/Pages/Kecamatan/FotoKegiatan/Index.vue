...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/foto-kegiatan/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiCamera" title="Foto Kegiatan Kecamatan" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Foto Kegiatan</h3>
        <Link
          href="/kecamatan/foto-kegiatan/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/foto-kegiatan/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/foto-kegiatan/${item.id}/edit`"
