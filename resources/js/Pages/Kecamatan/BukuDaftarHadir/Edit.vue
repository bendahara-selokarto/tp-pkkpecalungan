...
const submit = () => {
  form.put(`/kecamatan/buku-daftar-hadir/${props.item.id}`)
}
</script>

<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountMultipleCheckOutline" title="Edit Buku Daftar Hadir Kecamatan" main />
