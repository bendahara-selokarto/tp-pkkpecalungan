...
const submit = () => {
  ...
  form.post(`/kecamatan/buku-daftar-hadir/${props.item.id}`, {
    forceFormData: true,
    onBefore: () => {
      form._method = 'PUT'
    },
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountMultipleCheckOutline" title="Edit Buku Daftar Hadir" main />

    <CardBox is-form @submit.prevent="submit">
      <FormField label="Judul Daftar Hadir" :error="form.errors.title" help="Contoh: Daftar Hadir Pertemuan Rutin TP PKK Mei 2026">
        <input
          v-model="form.title"
          type="text"
