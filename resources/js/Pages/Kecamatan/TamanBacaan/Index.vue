...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/taman-bacaan', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
  ...
  <SectionMain>
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Data Isian Taman Bacaan/Perpustakaan</h3>
        <div class="flex items-center gap-2">
          ...
          <a
            href="/kecamatan/taman-bacaan/report/pdf"
            target="_blank"
            rel="noopener"
          ...
          <Link
            href="/kecamatan/taman-bacaan/create"
        ...
        <table class="w-full min-w-[980px] text-sm">
          <thead class="border-b border-gray-200 dark:border-slate-700">
            <tr class="text-left text-gray-600 dark:text-gray-300">
              <th class="px-3 py-3 font-semibold">Nama Taman Bacaan/Perpustakaan</th>
          ...
          <tbody>
            <tr
              v-for="item in tamanBacaanItems.data"
              :key="item.id"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/taman-bacaan/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/taman-bacaan/${item.id}/edit`"
            ...
            <tr v-if="tamanBacaanItems.data.length === 0">
              <td colspan="7" class="px-3 py-6 text-center text-sm text-gray-500 dark:text-gray-400">
                Data isian taman bacaan/perpustakaan belum tersedia.
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <PaginationBar
        :links="tamanBacaanItems.links"
        :from="tamanBacaanItems.from"
        :to="tamanBacaanItems.to"
        :total="tamanBacaanItems.total"
      />
    </CardBox>
