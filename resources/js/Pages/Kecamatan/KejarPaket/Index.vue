...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/kejar-paket', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
}
const deleteConfirmationMessage = 'Apakah Anda yakin ingin menghapus data kejar paket ini?'
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/kejar-paket/${deletingId.value}`, {
    onFinish: () => {
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <Link
            href="/kecamatan/kejar-paket/create"
...
<div class="overflow-x-auto">
        <table class="w-full min-w-[980px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in props.kejarPaketItems.data"
              :key="item.id"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/kejar-paket/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/kejar-paket/${item.id}/edit`"
            ...
            <tr v-if="props.kejarPaketItems.data.length === 0">
      ...
      <PaginationBar
        :links="props.kejarPaketItems.links"
        :from="props.kejarPaketItems.from"
        :to="props.kejarPaketItems.to"
        :total="props.kejarPaketItems.total"
      />
    </CardBox>
