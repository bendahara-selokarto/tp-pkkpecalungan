...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/activities/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiClipboardList" title="Buku Kegiatan Kecamatan" main />
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/activities/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/activities/${item.id}/edit`"
