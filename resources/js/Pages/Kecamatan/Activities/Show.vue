  ...
  <SectionMain>
    ...
    <CardBox class="max-w-3xl space-y-4">
      ...
      <div class="flex items-center justify-end gap-2">
        ...
        <Link :href="`/kecamatan/activities/${props.activity.id}/edit`" class="inline-flex rounded-md bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">
          Edit
        </Link>
      </div>
    </CardBox>
