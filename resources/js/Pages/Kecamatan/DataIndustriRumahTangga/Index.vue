...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/data-industri-rumah-tangga', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/data-industri-rumah-tangga/${deletingId.value}`, {
    onFinish: () => {
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <Link
            href="/kecamatan/data-industri-rumah-tangga/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/data-industri-rumah-tangga/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/data-industri-rumah-tangga/${item.id}/edit`"
