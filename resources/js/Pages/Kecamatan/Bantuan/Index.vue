...
const hapusBantuan = (id) => {
  if (!window.confirm('Apakah Anda yakin ingin menghapus data bantuan ini?')) {
    return
  }

  router.delete(`/kecamatan/bantuans/${id}`)
}
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiHandHeart" title="Bantuan Kecamatan" main />
    ...
    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <Link
            href="/kecamatan/bantuans/create"
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/bantuans/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/bantuans/${item.id}/edit`"
