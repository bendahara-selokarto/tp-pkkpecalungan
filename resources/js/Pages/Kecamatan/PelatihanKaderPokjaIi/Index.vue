...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/pelatihan-kader-pokja-ii', {
    ...props.filters,
    page: 1,
...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/pelatihan-kader-pokja-ii/${deletingId.value}`, {
    onFinish: () => {
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton :icon="mdiAccountGroup" title="Pelatihan Kader Pokja II Kecamatan" main />

    <CardBox>
      <div class="mb-4 flex items-center justify-between gap-4">
        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Daftar Pelatihan Kader Pokja II</h3>
        <Link
          href="/kecamatan/pelatihan-kader-pokja-ii/create"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/pelatihan-kader-pokja-ii/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/pelatihan-kader-pokja-ii/${item.id}/edit`"
