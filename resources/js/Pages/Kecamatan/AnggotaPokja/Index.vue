...
const confirmDelete = () => {
  ...
  router.delete(`/kecamatan/anggota-pokja/${deletingId.value}`, {
    onFinish: () => {
...
const updatePerPage = (event) => {
  ...
  router.get('/kecamatan/anggota-pokja', { per_page: selectedPerPage }, {
    preserveScroll: true,
    preserveState: true,
    replace: true,
  })
    ...
    <CardBox>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[900px] text-sm">
          ...
          <tbody>
            <tr
              v-for="item in anggotaPokjas.data"
              :key="item.id"
            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center gap-2">
                  <Link
                    :href="`/kecamatan/anggota-pokja/${item.id}`"
                  ...
                  <Link
                    :href="`/kecamatan/anggota-pokja/${item.id}/edit`"
            ...
            <tr v-if="anggotaPokjas.data.length === 0">
      ...
      <PaginationBar
        :links="anggotaPokjas.links"
        :from="anggotaPokjas.from"
        :to="anggotaPokjas.to"
        :total="anggotaPokjas.total"
      />
    </CardBox>
