...
const form = useForm({
  ...
  dokumentasi: '',
  penutup: '',
  tahun_awal: props.defaultPeriod?.tahun_awal ?? 2021,
  tahun_akhir: props.defaultPeriod?.tahun_akhir ?? 2024,
  values: buildCatalogValues(
    props.sections,
    props.defaultPeriod?.tahun_awal ?? 2021,
    props.defaultPeriod?.tahun_akhir ?? 2024,
  ),
})
...
<template>
  <SectionMain>
    <SectionTitleLineWithButton
      ...
      :title="`Tambah Laporan Pilot Project ${scopeLabel}`"
      main
    />
