...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-100 via-white to-emerald-50 text-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 dark:text-slate-100">
