<script setup>
import BaseDivider from '@/admin-one/components/BaseDivider.vue';
import BaseIcon from '@/admin-one/components/BaseIcon.vue';
import NavBarMenuList from '@/admin-one/components/NavBarMenuList.vue';
...
const itemLabel = computed(() =>
  props.item.isCurrentUser ? page.props.auth?.user?.name ?? 'User' : props.item.label,
);
