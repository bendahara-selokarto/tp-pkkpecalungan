...
- Kontrak domain baru (4.14.1a-4.15) sudah dipetakan; implementasi masuk fase bertahap. Modul 4.14.1a (`data-warga`), 4.14.1b (`data-kegiatan-warga`), 4.14.2a (`data-keluarga`), dan 4.14.2b (`data-pemanfaatan-tanah-pekarangan-hatinya-pkk`) sudah selesai.
