...
class KecamatanDataWargaTest extends TestCase
{
    ...
    #[Test]
    public function admin_kecamatan_tidak_bisa_melihat_detail_data_warga_tahun_anggaran_lain(): void
    {
        $adminKecamatan = User::factory()->create([
            'area_id' => $this->kecamatanA->id,
            'scope' => 'kecamatan',
        ...
        $response = $this->actingAs($adminKecamatan)
            ->get(route('kecamatan.data-warga.show', $dataWargaTahunLalu->id));
