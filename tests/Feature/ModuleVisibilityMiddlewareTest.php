...
class ModuleVisibilityMiddlewareTest extends TestCase
{
    ...
    public function test_desa_pokja_i_iii_iv_memiliki_akses_rw_modul_inventaris(): void
    {
        foreach (['desa-pokja-ii'] as $role) {
            $user = User::factory()->create([
                'scope' => 'desa',
                'area_id' => $this->desa->id,
            ]);
        ...
        foreach (['desa-pokja-i', 'desa-pokja-iii', 'desa-pokja-iv'] as $role) {
            $user = User::factory()->create([
                'scope' => 'desa',
                'area_id' => $this->desa->id,
            ]);
            ...
            $this->actingAs($user)->get('/desa/inventaris')->assertOk();
            $this->actingAs($user)->get('/desa/inventaris/create')->assertOk();
    ...
    public function test_kecamatan_pokja_i_iii_iv_memiliki_akses_rw_modul_inventaris(): void
    {
        foreach (['kecamatan-pokja-ii'] as $role) {
            $user = User::factory()->create([
                'scope' => 'kecamatan',
                'area_id' => $this->kecamatan->id,
            ]);
        ...
        foreach (['kecamatan-pokja-i', 'kecamatan-pokja-iii', 'kecamatan-pokja-iv'] as $role) {
            $user = User::factory()->create([
                'scope' => 'kecamatan',
                'area_id' => $this->kecamatan->id,
            ]);
            ...
            $this->actingAs($user)->get('/kecamatan/inventaris')->assertOk();
            $this->actingAs($user)->get('/kecamatan/inventaris/create')->assertOk();
