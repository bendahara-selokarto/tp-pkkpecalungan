...
class DataWargaReportPrintTest extends TestCase
{
    ...
    public function test_header_kolom_pdf_data_warga_tetap_sesuai_pedoman(): void
    {
        $this->assertPdfReportHeadersInOrder('pdf.data_warga_report', [
            'NO',
            'NO. REGISTRASI',
            'NO. KTP/KK',
            'NAMA',
