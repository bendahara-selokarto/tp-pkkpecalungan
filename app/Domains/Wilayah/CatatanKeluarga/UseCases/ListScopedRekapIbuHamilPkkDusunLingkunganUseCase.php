...
class ListScopedRekapIbuHamilPkkDusunLingkunganUseCase
{
    ...
    public function execute(string $level): Collection
    {
        ...
        return $this->catatanKeluargaRepository->getRekapIbuHamilPkkDusunLingkunganByLevelAndArea($level, $areaId);
    }
}
