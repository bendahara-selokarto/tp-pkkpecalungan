...
class KecamatanTamanBacaanController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedTamanBacaanUseCase->execute(ScopeLevel::KECAMATAN->value);
    ...
    public function store(StoreTamanBacaanRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.taman-bacaan.index')->with('success', 'Data taman bacaan berhasil dibuat');
    }
    ...
    public function update(UpdateTamanBacaanRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.taman-bacaan.index')->with('success', 'Data taman bacaan berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.taman-bacaan.index')->with('success', 'Data taman bacaan berhasil dihapus');
    }
}
