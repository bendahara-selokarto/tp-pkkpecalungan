...
class DesaPilotProjectNaskahPelaporanController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('PilotProjectNaskahPelaporan/Create', [
            ...
            'defaultLetterFrom' => $this->defaultLetterFrom('Desa'),
    ...
    public function store(StorePilotProjectNaskahPelaporanRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('desa.pilot-project-naskah-pelaporan.index')
