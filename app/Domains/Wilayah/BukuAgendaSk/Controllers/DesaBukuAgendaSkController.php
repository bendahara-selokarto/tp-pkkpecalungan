...
class DesaBukuAgendaSkController extends Controller
{
    ...
    public function index(ListBukuAgendaSkRequest $request): Response
    {
        ...
        return Inertia::render('Desa/BukuAgendaSk/Index', [
            'items' => $items,
            'pagination' => [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/BukuAgendaSk/Create');
    }

    public function store(StoreBukuAgendaSkRequest $request): RedirectResponse
    {
        $this->authorize('create', BukuAgendaSk::class);
        $this->createScopedBukuAgendaSkAction->execute($request->validated(), 'desa');
    ...
    public function show(int $id): Response
    {
        ...
        return Inertia::render('Desa/BukuAgendaSk/Show', [
            'item' => [
                'id' => $item->id,
                'nomor_sk' => $item->nomor_sk,
                'tanggal_sk' => $this->formatDateForPayload($item->tanggal_sk),
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/BukuAgendaSk/Edit', [
            'item' => [
                'id' => $item->id,
                'nomor_sk' => $item->nomor_sk,
                'tanggal_sk' => $this->formatDateForPayload($item->tanggal_sk),
