...
class KecamatanAnggotaPokjaController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $anggotaPokjas = $this->listScopedAnggotaPokjaUseCase->execute('kecamatan');

        return Inertia::render('Kecamatan/AnggotaPokja/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/AnggotaPokja/Create');
    }

    public function store(StoreAnggotaPokjaRequest $request): RedirectResponse
    {
        $this->authorize('create', AnggotaPokja::class);
        $this->createScopedAnggotaPokjaAction->execute($request->validated(), 'kecamatan');

        return redirect()->route('kecamatan.anggota-pokja.index')->with('success', 'Data anggota pokja berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $anggotaPokja = $this->getScopedAnggotaPokjaUseCase->execute($id, 'kecamatan');
        $this->authorize('view', $anggotaPokja);

        return Inertia::render('Kecamatan/AnggotaPokja/Show', [
            'anggotaPokja' => [
                'id' => $anggotaPokja->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/AnggotaPokja/Edit', [
            'anggotaPokja' => [
                'id' => $anggotaPokja->id,
                'nama' => $anggotaPokja->nama,
                'jabatan' => $anggotaPokja->jabatan,
    ...
    public function update(UpdateAnggotaPokjaRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.anggota-pokja.index')->with('success', 'Data anggota pokja berhasil diupdate');
    }
