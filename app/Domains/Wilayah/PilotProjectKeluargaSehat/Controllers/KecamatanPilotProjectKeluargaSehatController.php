...
class KecamatanPilotProjectKeluargaSehatController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('PilotProjectKeluargaSehat/Index', [
            ...
            'scopePrefix' => '/kecamatan/pilot-project-keluarga-sehat',
            'reports' => $reports,
        ]);
    }
    ...
    public function store(StorePilotProjectKeluargaSehatRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('kecamatan.pilot-project-keluarga-sehat.index')
