...
class DesaLiterasiWargaController extends Controller
{
    ...
    public function index(ListLiterasiWargaRequest $request): Response
    {
        ...
        return Inertia::render('Desa/LiterasiWarga/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/LiterasiWarga/Create');
    }

    public function store(StoreLiterasiWargaRequest $request): RedirectResponse
    {
        $this->authorize('create', LiterasiWarga::class);
        $this->createScopedLiterasiWargaAction->execute($request->validated(), ScopeLevel::DESA->value);

        return redirect()->route('desa.literasi-warga.index')->with('success', 'Data literasi warga berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $literasiWarga = $this->getScopedLiterasiWargaUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $literasiWarga);

        return Inertia::render('Desa/LiterasiWarga/Show', [
            'literasiWarga' => [
                'id' => $literasiWarga->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/LiterasiWarga/Edit', [
            'literasiWarga' => [
                'id' => $literasiWarga->id,
                'jumlah_tiga_buta' => $literasiWarga->jumlah_tiga_buta,
                'keterangan' => $literasiWarga->keterangan,
    ...
    public function update(UpdateLiterasiWargaRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.literasi-warga.index')->with('success', 'Data literasi warga berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.literasi-warga.index')->with('success', 'Data literasi warga berhasil dihapus');
    }
}
