...
class KecamatanDataPelatihanKaderController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/DataPelatihanKader/Create', [
    ...
    {
        $this->authorize('create', DataPelatihanKader::class);
        $this->createScopedDataPelatihanKaderAction->execute($request->validated(), ScopeLevel::KECAMATAN->value);

        return redirect()->route('kecamatan.data-pelatihan-kader.index')->with('success', 'Data Pelatihan Kader berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $dataPelatihanKader = $this->getScopedDataPelatihanKaderUseCase->execute($id, ScopeLevel::KECAMATAN->value);
        $this->authorize('view', $dataPelatihanKader);

        return Inertia::render('Kecamatan/DataPelatihanKader/Show', [
            'dataPelatihanKader' => [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/DataPelatihanKader/Edit', [
            'dataPelatihanKader' => [
                'id' => $dataPelatihanKader->id,
                'nomor_registrasi' => $dataPelatihanKader->nomor_registrasi,
                'nama_lengkap_kader' => $dataPelatihanKader->nama_lengkap_kader,
    ...
    public function update(UpdateDataPelatihanKaderRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.data-pelatihan-kader.index')->with('success', 'Data Pelatihan Kader berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.data-pelatihan-kader.index')->with('success', 'Data Pelatihan Kader berhasil dihapus');
    }
}
