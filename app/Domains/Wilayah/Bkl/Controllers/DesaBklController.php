...
class DesaBklController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedBklUseCase->execute(ScopeLevel::DESA->value);
    ...
    public function store(StoreBklRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('desa.bkl.index')->with('success', 'Data BKL berhasil dibuat');
    }
    ...
    public function update(UpdateBklRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.bkl.index')->with('success', 'Data BKL berhasil diupdate');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.bkl.index')->with('success', 'Data BKL berhasil dihapus');
    }
}
