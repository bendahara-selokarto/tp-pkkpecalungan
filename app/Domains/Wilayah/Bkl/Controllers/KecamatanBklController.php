...
class KecamatanBklController extends Controller
{
    ...
    public function store(StoreBklRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.bkl.index')->with('success', 'Data kelompok BKL berhasil dibuat');
    }
    ...
    public function update(UpdateBklRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.bkl.index')->with('success', 'Data kelompok BKL berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.bkl.index')->with('success', 'Data kelompok BKL berhasil dihapus');
    }
}
