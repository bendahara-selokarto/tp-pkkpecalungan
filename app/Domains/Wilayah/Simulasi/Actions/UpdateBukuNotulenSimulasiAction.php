...
class UpdateBukuNotulenSimulasiAction
{
    ...
    public function execute(BukuNotulenSimulasi $model, array $payload): BukuNotulenSimulasi
    {
        $fileInfo = [
        ...
        if (isset($payload['file']) && $payload['file'] instanceof \Illuminate\Http\UploadedFile) {
            ...
            $storedPath = $uploadedFile->store('buku-notulen-simulasi', 'public');
            $fileInfo = [
        ...
        $data = BukuNotulenSimulasiData::fromArray([
            ...$payload,
            ...$fileInfo,
            'level' => $model->level,
