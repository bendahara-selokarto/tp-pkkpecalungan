...
class DesaBukuDaftarHadirSimulasiController extends Controller
{
    ...
    public function index(ListSimulasiRequest $request): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuDaftarHadir/Index', [
            'items' => $items,
            'filters' => [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuDaftarHadir/Create');
    }
    ...
    public function store(StoreBukuDaftarHadirSimulasiRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('desa.simulasi.buku-daftar-hadir.index')
    ...
    public function show(int $id): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuDaftarHadir/Show', [
            'item' => [
                ...$item->toArray(),
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuDaftarHadir/Edit', [
            'item' => [
                ...$item->toArray(),
                'file_url' => $item->file_url,
            ],
