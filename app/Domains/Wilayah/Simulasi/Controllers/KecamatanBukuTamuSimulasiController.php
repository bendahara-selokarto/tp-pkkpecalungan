...
class KecamatanBukuTamuSimulasiController extends Controller
{
    ...
    public function index(ListSimulasiRequest $request): Response
    {
        ...
        return Inertia::render('Kecamatan/Simulasi/BukuTamu/Index', [
            'items' => $items,
            'filters' => [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/Simulasi/BukuTamu/Create');
    }
    ...
    public function store(StoreBukuTamuSimulasiRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.simulasi.buku-tamu.index')
    ...
    public function show(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/Simulasi/BukuTamu/Show', [
            'item' => [
                ...$item->toArray(),
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/Simulasi/BukuTamu/Edit', [
            'item' => [
                ...$item->toArray(),
                'file_url' => $item->file_url,
            ],
