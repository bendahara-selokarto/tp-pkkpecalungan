...
class DesaBukuNotulenSimulasiController extends Controller
{
    ...
    public function index(ListSimulasiRequest $request): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuNotulen/Index', [
            'items' => $items,
            'filters' => [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuNotulen/Create');
    }
    ...
    public function store(StoreBukuNotulenSimulasiRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('desa.simulasi.buku-notulen.index')
    ...
    public function show(int $id): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuNotulen/Show', [
            'item' => [
                ...$item->toArray(),
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/Simulasi/BukuNotulen/Edit', [
            'item' => [
                ...$item->toArray(),
                'file_url' => $item->file_url,
            ],
