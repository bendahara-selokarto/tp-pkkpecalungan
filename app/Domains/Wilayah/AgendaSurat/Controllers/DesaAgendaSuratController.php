...
class DesaAgendaSuratController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedAgendaSuratUseCase->execute('desa');

        return Inertia::render('Desa/AgendaSurat/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/AgendaSurat/Create');
    }

    public function store(StoreAgendaSuratRequest $request): RedirectResponse
    {
        $this->authorize('create', AgendaSurat::class);
        $this->createScopedAgendaSuratAction->execute($request->validated(), 'desa');

        return redirect()->route('desa.agenda-surat.index')->with('success', 'Agenda surat berhasil dibuat');
    }
    ...
    public function show(int $id): Response
    {
        ...
        return Inertia::render('Desa/AgendaSurat/Show', [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/AgendaSurat/Edit', [
    ...
    public function update(UpdateAgendaSuratRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.agenda-surat.index')->with('success', 'Agenda surat berhasil diperbarui');
    }
