...
class KecamatanPelatihanKaderPokjaIiController extends Controller
{
    ...
    public function index(ListPelatihanKaderPokjaIiRequest $request): Response
    {
        ...
        $items = $this->listScopedPelatihanKaderPokjaIiUseCase->execute(ScopeLevel::KECAMATAN->value, $request->perPage());

        return Inertia::render('Kecamatan/PelatihanKaderPokjaIi/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/PelatihanKaderPokjaIi/Create');
    }

    public function store(StorePelatihanKaderPokjaIiRequest $request): RedirectResponse
    {
        $this->authorize('create', PelatihanKaderPokjaIi::class);
        $this->createScopedPelatihanKaderPokjaIiAction->execute($request->validated(), ScopeLevel::KECAMATAN->value);

        return redirect()->route('kecamatan.pelatihan-kader-pokja-ii.index')->with('success', 'Data pelatihan kader Pokja II berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $pelatihanKader = $this->getScopedPelatihanKaderPokjaIiUseCase->execute($id, ScopeLevel::KECAMATAN->value);
        $this->authorize('view', $pelatihanKader);

        return Inertia::render('Kecamatan/PelatihanKaderPokjaIi/Show', [
            'pelatihanKader' => [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/PelatihanKaderPokjaIi/Edit', [
            'pelatihanKader' => [
                'id' => $pelatihanKader->id,
                'kategori_pelatihan' => $pelatihanKader->kategori_pelatihan,
                'jumlah_kader' => $pelatihanKader->jumlah_kader,
    ...
    public function update(UpdatePelatihanKaderPokjaIiRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.pelatihan-kader-pokja-ii.index')->with('success', 'Data pelatihan kader Pokja II berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.pelatihan-kader-pokja-ii.index')->with('success', 'Data pelatihan kader Pokja II berhasil dihapus');
    }
}
