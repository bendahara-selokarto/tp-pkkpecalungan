...
class KecamatanAnggotaTimPenggerakController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $anggotaTimPenggeraks = $this->listScopedAnggotaTimPenggerakUseCase->execute('kecamatan');

        return Inertia::render('Kecamatan/AnggotaTimPenggerak/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/AnggotaTimPenggerak/Create');
    }

    public function store(StoreAnggotaTimPenggerakRequest $request): RedirectResponse
    {
        $this->authorize('create', AnggotaTimPenggerak::class);
        $this->createScopedAnggotaTimPenggerakAction->execute($request->validated(), 'kecamatan');

        return redirect()->route('kecamatan.anggota-tim-penggerak.index')->with('success', 'Data anggota tim penggerak berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $anggotaTimPenggerak = $this->getScopedAnggotaTimPenggerakUseCase->execute($id, 'kecamatan');
        $this->authorize('view', $anggotaTimPenggerak);

        return Inertia::render('Kecamatan/AnggotaTimPenggerak/Show', [
            'anggotaTimPenggerak' => [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/AnggotaTimPenggerak/Edit', [
            'anggotaTimPenggerak' => [
                'id' => $anggotaTimPenggerak->id,
                'nama' => $anggotaTimPenggerak->nama,
                'jabatan' => $anggotaTimPenggerak->jabatan,
    ...
    public function update(UpdateAnggotaTimPenggerakRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.anggota-tim-penggerak.index')->with('success', 'Data anggota tim penggerak berhasil diupdate');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.anggota-tim-penggerak.index')->with('success', 'Data anggota tim penggerak berhasil dihapus');
    }
}
