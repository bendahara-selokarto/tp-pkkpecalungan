...
class KecamatanKaderKhususController extends Controller
{
    ...
    public function store(StoreKaderKhususRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.kader-khusus.index')->with('success', 'Data buku kader khusus berhasil dibuat');
    }
    ...
    public function update(UpdateKaderKhususRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.kader-khusus.index')->with('success', 'Data buku kader khusus berhasil diperbarui');
    }
