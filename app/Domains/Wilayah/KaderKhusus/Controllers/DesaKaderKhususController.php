...
class DesaKaderKhususController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/KaderKhusus/Create');
    }
    ...
    public function store(StoreKaderKhususRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('desa.kader-khusus.index')->with('success', 'Data kader khusus berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $kaderKhusus = $this->getScopedKaderKhususUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $kaderKhusus);

        return Inertia::render('Desa/KaderKhusus/Show', [
            'kaderKhusus' => [
                'id' => $kaderKhusus->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/KaderKhusus/Edit', [
            'kaderKhusus' => [
                'id' => $kaderKhusus->id,
                'nama' => $kaderKhusus->nama,
                'jenis_kelamin' => $kaderKhusus->jenis_kelamin,
    ...
    public function update(UpdateKaderKhususRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.kader-khusus.index')->with('success', 'Data kader khusus berhasil diupdate');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.kader-khusus.index')->with('success', 'Data kader khusus berhasil dihapus');
    }
}
