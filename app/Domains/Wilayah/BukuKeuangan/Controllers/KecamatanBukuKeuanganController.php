...
class KecamatanBukuKeuanganController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/BukuKeuangan/Create');
    }

    public function store(StoreBukuKeuanganRequest $request): RedirectResponse
    {
        $this->authorize('create', BukuKeuangan::class);
        $this->createScopedBukuKeuanganAction->execute($request->validated(), 'kecamatan');

        return redirect()->route('kecamatan.buku-keuangan.index')->with('success', 'Transaksi buku keuangan berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $bukuKeuangan = $this->getScopedBukuKeuanganUseCase->execute($id, 'kecamatan');
        $this->authorize('view', $bukuKeuangan);

        return Inertia::render('Kecamatan/BukuKeuangan/Show', [
            'entry' => [
                'id' => $bukuKeuangan->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/BukuKeuangan/Edit', [
            'entry' => [
                'id' => $bukuKeuangan->id,
                'transaction_date' => $this->formatDateForPayload($bukuKeuangan->transaction_date?->format('Y-m-d')),
                'source' => $bukuKeuangan->source,
    ...
    public function update(UpdateBukuKeuanganRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.buku-keuangan.index')->with('success', 'Transaksi buku keuangan berhasil diupdate');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.buku-keuangan.index')->with('success', 'Transaksi buku keuangan berhasil dihapus');
    }
