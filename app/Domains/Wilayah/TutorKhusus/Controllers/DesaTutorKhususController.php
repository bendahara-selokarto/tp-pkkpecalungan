...
class DesaTutorKhususController extends Controller
{
    ...
    public function index(ListTutorKhususRequest $request): Response
    {
        ...
        $items = $this->listScopedTutorKhususUseCase->execute(ScopeLevel::DESA->value, $request->perPage());

        return Inertia::render('Desa/TutorKhusus/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/TutorKhusus/Create');
    }

    public function store(StoreTutorKhususRequest $request): RedirectResponse
    {
        $this->authorize('create', TutorKhusus::class);
        $this->createScopedTutorKhususAction->execute($request->validated(), ScopeLevel::DESA->value);

        return redirect()->route('desa.tutor-khusus.index')->with('success', 'Data tutor khusus berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $tutorKhusus = $this->getScopedTutorKhususUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $tutorKhusus);

        return Inertia::render('Desa/TutorKhusus/Show', [
            'tutorKhusus' => [
                'id' => $tutorKhusus->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/TutorKhusus/Edit', [
            'tutorKhusus' => [
                'id' => $tutorKhusus->id,
                'jenis_tutor' => $tutorKhusus->jenis_tutor,
                'jumlah_tutor' => $tutorKhusus->jumlah_tutor,
    ...
    public function update(UpdateTutorKhususRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.tutor-khusus.index')->with('success', 'Data tutor khusus berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.tutor-khusus.index')->with('success', 'Data tutor khusus berhasil dihapus');
    }
}
