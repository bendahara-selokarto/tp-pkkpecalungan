...
class DesaBkbKegiatanController extends Controller
{
    ...
    public function index(ListBkbKegiatanRequest $request): Response
    {
        ...
        $items = $this->listScopedBkbKegiatanUseCase->execute(ScopeLevel::DESA->value, $request->perPage());

        return Inertia::render('Desa/BkbKegiatan/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/BkbKegiatan/Create');
    }

    public function store(StoreBkbKegiatanRequest $request): RedirectResponse
    {
        $this->authorize('create', BkbKegiatan::class);
        $this->createScopedBkbKegiatanAction->execute($request->validated(), ScopeLevel::DESA->value);

        return redirect()->route('desa.bkb-kegiatan.index')->with('success', 'Data BKB berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $bkbKegiatan = $this->getScopedBkbKegiatanUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $bkbKegiatan);

        return Inertia::render('Desa/BkbKegiatan/Show', [
            'bkbKegiatan' => [
                'id' => $bkbKegiatan->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/BkbKegiatan/Edit', [
            'bkbKegiatan' => [
                'id' => $bkbKegiatan->id,
                'jumlah_kelompok' => $bkbKegiatan->jumlah_kelompok,
                'jumlah_ibu_peserta' => $bkbKegiatan->jumlah_ibu_peserta,
    ...
    public function update(UpdateBkbKegiatanRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.bkb-kegiatan.index')->with('success', 'Data BKB berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.bkb-kegiatan.index')->with('success', 'Data BKB berhasil dihapus');
    }
}
