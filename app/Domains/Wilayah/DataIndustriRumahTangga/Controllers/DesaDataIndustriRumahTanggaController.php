...
class DesaDataIndustriRumahTanggaController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedDataIndustriRumahTanggaUseCase->execute(ScopeLevel::DESA->value);
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/DataIndustriRumahTangga/Create', [
    ...
    {
        $this->authorize('create', DataIndustriRumahTangga::class);
        $this->createScopedDataIndustriRumahTanggaAction->execute($request->validated(), ScopeLevel::DESA->value);

        return redirect()->route('desa.data-industri-rumah-tangga.index')->with('success', 'Data Industri Rumah Tangga berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $dataIndustriRumahTangga = $this->getScopedDataIndustriRumahTanggaUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $dataIndustriRumahTangga);

        return Inertia::render('Desa/DataIndustriRumahTangga/Show', [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/DataIndustriRumahTangga/Edit', [
            'dataIndustriRumahTangga' => [
                'id' => $dataIndustriRumahTangga->id,
                'kategori_jenis_industri' => $dataIndustriRumahTangga->kategori_jenis_industri,
                'komoditi' => $dataIndustriRumahTangga->komoditi,
    ...
    public function update(UpdateDataIndustriRumahTanggaRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-industri-rumah-tangga.index')->with('success', 'Data Industri Rumah Tangga berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-industri-rumah-tangga.index')->with('success', 'Data Industri Rumah Tangga berhasil dihapus');
    }
}
