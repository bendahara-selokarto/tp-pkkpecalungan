...
class DesaDataIndustriRumahTanggaController extends Controller
{
    ...
    public function store(StoreDataIndustriRumahTanggaRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-industri-rumah-tangga.index')->with('success', 'Buku Industri Rumah Tangga berhasil dibuat');
    }
    ...
    public function update(UpdateDataIndustriRumahTanggaRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-industri-rumah-tangga.index')->with('success', 'Buku Industri Rumah Tangga berhasil diperbarui');
    }
