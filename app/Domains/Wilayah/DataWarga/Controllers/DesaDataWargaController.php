...
class DesaDataWargaController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedDataWargaUseCase->execute(ScopeLevel::DESA->value);

        return Inertia::render('Desa/DataWarga/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/DataWarga/Create');
    }

    public function store(StoreDataWargaRequest $request): RedirectResponse
    {
        $this->authorize('create', DataWarga::class);
        $this->createScopedDataWargaAction->execute($request->validated(), ScopeLevel::DESA->value);

        return redirect()->route('desa.data-warga.index')->with('success', 'Data warga berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $dataWarga = $this->getScopedDataWargaUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $dataWarga);

        return Inertia::render('Desa/DataWarga/Show', [
            'dataWarga' => [
                'id' => $dataWarga->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/DataWarga/Edit', [
            'dataWarga' => [
                'id' => $dataWarga->id,
                'dasawisma' => $dataWarga->dasawisma,
                'nama_kepala_keluarga' => $dataWarga->nama_kepala_keluarga,
    ...
    public function update(UpdateDataWargaRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-warga.index')->with('success', 'Data warga berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('desa.data-warga.index')->with('success', 'Data warga berhasil dihapus');
    }
}
