...
class KecamatanWarungPkkController extends Controller
{
    ...
    public function store(StoreWarungPkkRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.warung-pkk.index')->with('success', 'Data warung PKK berhasil dibuat');
    }
    ...
    public function update(UpdateWarungPkkRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.warung-pkk.index')->with('success', 'Data warung PKK berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.warung-pkk.index')->with('success', 'Data warung PKK berhasil dihapus');
    }
}
