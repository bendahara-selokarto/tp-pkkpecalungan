...
class DesaPrestasiLombaController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/PrestasiLomba/Create');
    }
    ...
    {
        $prestasiLomba = $this->getScopedPrestasiLombaUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $prestasiLomba);

        return Inertia::render('Desa/PrestasiLomba/Show', [
            'prestasiLomba' => [
                'id' => $prestasiLomba->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/PrestasiLomba/Edit', [
            'prestasiLomba' => [
                'id' => $prestasiLomba->id,
                'tahun' => $prestasiLomba->tahun,
                'jenis_lomba' => $prestasiLomba->jenis_lomba,
