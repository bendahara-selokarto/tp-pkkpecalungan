...
class RoleMenuVisibilityService
{
    ...
    private const ROLE_MODULE_MODE_OVERRIDES = [
        // Grant khusus: inventaris + buku-tamu RW untuk seluruh pokja pada scope desa.
        'desa-pokja-i' => [
            'inventaris' => self::MODE_READ_WRITE,
            'buku-tamu' => self::MODE_READ_WRITE,
        ],
        'desa-pokja-ii' => [
            'inventaris' => self::MODE_READ_WRITE,
            'buku-tamu' => self::MODE_READ_WRITE,
        ...
        'kecamatan-pokja-i' => [
            ...
            'data-kegiatan-pkk-pokja-i' => self::MODE_READ_ONLY,
        ...
        'kecamatan-pokja-ii' => [
            ...
            'bkb-kegiatan' => null,
            'tutor-khusus' => null,
            'pelatihan-kader-pokja-ii' => null,
            'pra-koperasi-up2k' => null,
            'anggota-pokja' => self::MODE_READ_WRITE,
            'prestasi-lomba' => self::MODE_READ_WRITE,
        ],
        'kecamatan-pokja-iii' => [
