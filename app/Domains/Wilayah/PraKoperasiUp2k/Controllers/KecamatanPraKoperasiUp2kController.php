...
class KecamatanPraKoperasiUp2kController extends Controller
{
    ...
    public function index(ListPraKoperasiUp2kRequest $request): Response
    {
        ...
        $items = $this->listScopedPraKoperasiUp2kUseCase->execute(ScopeLevel::KECAMATAN->value, $request->perPage());

        return Inertia::render('Kecamatan/PraKoperasiUp2k/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/PraKoperasiUp2k/Create');
    }

    public function store(StorePraKoperasiUp2kRequest $request): RedirectResponse
    {
        $this->authorize('create', PraKoperasiUp2k::class);
        $this->createScopedPraKoperasiUp2kAction->execute($request->validated(), ScopeLevel::KECAMATAN->value);

        return redirect()->route('kecamatan.pra-koperasi-up2k.index')->with('success', 'Data pra koperasi/UP2K berhasil dibuat');
    }

    public function show(int $id): Response
    {
        $praKoperasi = $this->getScopedPraKoperasiUp2kUseCase->execute($id, ScopeLevel::KECAMATAN->value);
        $this->authorize('view', $praKoperasi);

        return Inertia::render('Kecamatan/PraKoperasiUp2k/Show', [
            'praKoperasi' => [
                'id' => $praKoperasi->id,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/PraKoperasiUp2k/Edit', [
            'praKoperasi' => [
                'id' => $praKoperasi->id,
                'tingkat' => $praKoperasi->tingkat,
                'jumlah_kelompok' => $praKoperasi->jumlah_kelompok,
    ...
    public function update(UpdatePraKoperasiUp2kRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.pra-koperasi-up2k.index')->with('success', 'Data pra koperasi/UP2K berhasil diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        return redirect()->route('kecamatan.pra-koperasi-up2k.index')->with('success', 'Data pra koperasi/UP2K berhasil dihapus');
    }
}
