...
class KecamatanPaarController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('Kecamatan/Paar/Index', [
            'paarItems' => $this->buildItemsPayload(ScopeLevel::KECAMATAN->value),
        ]);
    }
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Kecamatan/Paar/Create', [
    ...
    {
        $paar = $this->getScopedPaarUseCase->execute($id, ScopeLevel::KECAMATAN->value);
        $this->authorize('view', $paar);

        return Inertia::render('Kecamatan/Paar/Show', [
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Kecamatan/Paar/Edit', [
            'paar' => $this->buildItemPayload($paar),
            'indicatorOptions' => Paar::indicatorOptions(),
        ]);
    }
