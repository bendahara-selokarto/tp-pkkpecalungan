    ...
    private function moduleDefinitions(): array
    {
        return [
            ...
            [
                'lampiran' => '4.13',
                'lampiran_group' => '4.13',
                'slug' => 'buku-notulen-rapat',
                'label' => 'Buku Notulen Rapat',
                'model' => \App\Domains\Wilayah\BukuNotulenRapat\Models\BukuNotulenRapat::class,
                'include_descendant_for_kecamatan' => false,
            ],
            [
                'lampiran' => '4.13',
                'lampiran_group' => '4.13',
                'slug' => 'buku-daftar-hadir',
                'label' => 'Buku Daftar Hadir',
                'model' => \App\Domains\Wilayah\BukuDaftarHadir\Models\BukuDaftarHadir::class,
                'include_descendant_for_kecamatan' => false,
            ],
            [
                'lampiran' => '4.13',
                ...
                'slug' => 'buku-tamu',
                'label' => 'Buku Tamu',
                'model' => \App\Domains\Wilayah\BukuTamu\Models\BukuTamu::class,
                'include_descendant_for_kecamatan' => false,
            ],
            [
                'lampiran' => '4.10',
                'lampiran_group' => '4.10',
                'slug' => 'buku-ekspedisi',
                'label' => 'Buku Ekspedisi',
                'model' => \App\Domains\Wilayah\BukuEkspedisi\Models\BukuEkspedisi::class,
                'include_descendant_for_kecamatan' => false,
            ],
            [
                'lampiran' => '4.14.1a',
