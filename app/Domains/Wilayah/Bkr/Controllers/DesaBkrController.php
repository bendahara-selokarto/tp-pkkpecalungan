...
class DesaBkrController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $items = $this->listScopedBkrUseCase->execute(ScopeLevel::DESA->value);
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Desa/Bkr/Create');
    }
    ...
    {
        $bkr = $this->getScopedBkrUseCase->execute($id, ScopeLevel::DESA->value);
        $this->authorize('view', $bkr);

        return Inertia::render('Desa/Bkr/Show', [
            'bkr' => [
                'id' => $bkr->id,
                'desa' => $bkr->desa,
    ...
    public function edit(int $id): Response
    {
        ...
        return Inertia::render('Desa/Bkr/Edit', [
            'bkr' => [
                'id' => $bkr->id,
                'desa' => $bkr->desa,
                'nama_bkr' => $bkr->nama_bkr,
