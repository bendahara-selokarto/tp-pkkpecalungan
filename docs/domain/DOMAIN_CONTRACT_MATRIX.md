...
| Ekstensi Lokal 2026 | `buku-tamu` | Buku Tamu | `visit_date`, `guest_name`, `purpose`, `institution`, `description` | - | Rakernas X (kelompok buku sekretaris) | implemented (modul desa/kecamatan aktif; autentikasi format tabel masih `unverified`) |
