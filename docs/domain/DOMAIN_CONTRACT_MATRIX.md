...
| 4.14.2b | `data-pemanfaatan-tanah-pekarangan-hatinya-pkk` | Pemanfaatan Tanah Pekarangan/AKU HATINYA PKK | `kategori_pemanfaatan_lahan`, `komoditi`, `jumlah_komoditi` | `PEMANFAATAN TANAH PEKARANGAN/AKU HATINYA PKK` | Rakernas X (Lampiran 4.14.2b) | match (header token autentik disederhanakan ke kolom 1-4) |
| 4.14.2c | `data-industri-rumah-tangga` | Data Industri Rumah Tangga | `kategori_jenis_industri`, `komoditi`, `jumlah_komoditi` | `DATA INDUSTRI RUMAH TANGGA` | Rakernas X (Lampiran 4.14.2c) | match |
