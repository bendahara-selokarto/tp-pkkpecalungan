...
### Normalisasi Label Canonical (Gelombang 1 - Backlog `missing`)
Label berikut dikunci sebagai istilah canonical lintas domain/process sebelum implementasi modul baru:

| Concern | Slug modul canonical | Label pedoman/canonical | Status |
| --- | --- | --- | --- |
| Buku sekretariat | `buku-notulen-rapat` | Buku Notulen Rapat | `missing` |
| Buku sekretariat | `buku-daftar-hadir` | Buku Daftar Hadir | `missing` |
| Buku sekretariat | `buku-tamu` | Buku Tamu | `missing` |
