...
| 4.16b | `rekap-catatan-data-kegiatan-warga-pkk-rt` (reference) | Rekapitulasi Catatan Data dan Kegiatan Warga Kelompok PKK RT | Dokumen autentik sudah terverifikasi; belum ada modul/report 30 kolom di aplikasi | Kunci sebagai referensi autentik + putuskan roadmap implementasi terpisah | reference-only |
