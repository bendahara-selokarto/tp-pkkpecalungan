...
| 4.21 | `data-kegiatan-pkk-pokja-i` | Data Kegiatan PKK (Pokja I) | Report PDF 27 kolom dengan merge-header autentik sudah tersedia (report-only) | Pertahankan label autentik + jaga validasi struktur kolom 1-27 untuk mencegah drift | implemented (report-only) |
