...
- Mengelola buku administrasi sekretaris di level desa.
...
2. Selesaikan input atau pembaruan data di modul sekretaris.
3. Tinjau modul pokja untuk memastikan data sudah terisi.
4. Cetak laporan bila dibutuhkan.

## Hasil yang Harus Terlihat

- Data baru muncul di daftar modul.
- Dashboard menampilkan ringkasan sesuai data terakhir.
- Laporan bisa dicetak dari modul yang relevan.
...
- Tombol tambah/ubah/hapus tidak muncul di modul pokja: itu normal karena modul pokja untuk sekretaris bersifat baca.
