...
| `C-PDF-DOMPDF-REFACTOR` | Refactoring laporan PDF sesuai standar DomPDF | `docs/process/TODO_PDF26R1_REFACTORING_LAPORAN_PDF_STANDAR_DOMPDF_2026_06_01.md` | `planned` | Refactoring menyeluruh template PDF agar patuh pada standar rendering DomPDF (colgroup, auto-layout). |
