...
| `C-UI-PAGINATION` | Pagination UI E2E | `docs/process/TODO_PGM26A1_MITIGASI_GAP_PAGINATION_2026_03_02.md` | `in-progress` (`mitigation-phase`) | `docs/process/TODO_UI_PAGINATION_E2E_2026_02_24.md` (`historical-baseline:done`) | Concern aktif pagination dilacak di `PGM26A1`; `UIP26A1` dipertahankan sebagai baseline historis fase awal E2E. |
