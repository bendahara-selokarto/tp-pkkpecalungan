...
| `C-SIDEBAR-UI` | Penataan menu/sidebar UI eksperimen | `docs/process/TODO_UI_MENU_VISIBILITY_ALIGNMENT_2026_02_25.md` | `active` (`rolling-ui-exp`) | `TODO_UI_VISIBILITY_BY_PENANGGUNGJAWAB.md`, `TODO_REFACTOR_DASHBOARD_LINTAS_ROLE_2026_02_24.md`, `TODO_MVI26A1_INVENTARIS_MODUL_VISIBILITY_2026_03_01.md` (`child-spec:in-progress`) | Untuk urutan/group/label sidebar: hanya ikuti `UVM25R1` marker `VIS-UI-EXP-2026-02-25-R2` (UI-only, non-E2E). Inventaris gap visibilitas lintas modul dijalankan pada child concern `MVI26A1`. |
| `C-ARSIP-MGMT` | Management arsip oleh super-admin | `docs/process/TODO_ASM26B1_MANAGEMENT_ARSIP_SUPER_ADMIN_2026_02_27.md` | `done` | `TODO_ARS26A1_MENU_ARSIP_DOKUMEN_STATIS_2026_02_27.md` (`historical-baseline`), `TODO_ARS26B2_HARDENING_AKSES_ARSIP_GLOBAL_PRIBADI_2026_02_28.md` (`child-spec:done`) | Untuk akses/management arsip gunakan `ASM26B1`; `ARS26A1` baseline historis, `ARS26B2` mengunci kontrak akses global/pribadi/monitoring. |
...
| `C-FIXTURE-TEMPLATE` | Konsistensi fixture dan template report print | `docs/process/TODO_FTC26A1_FIXTURE_TEMPLATE_CONSISTENCY_2026_03_01.md` | `active` (`isolated-regression-fix`) | `docs/process/OPERATIONAL_VALIDATION_LOG.md` (`blocker-trace`) | Kegagalan residual fixture/template ditangani di concern ini (terpisah dari process execution). |
...
- [x] Concern turunan `MVI26A1` ditautkan ke `C-SIDEBAR-UI` untuk menutup drift status `in-progress` di luar registry.
