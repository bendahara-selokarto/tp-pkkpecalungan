...
| `C-UI-PAGINATION` | Pagination UI E2E | `docs/process/TODO_UI_PAGINATION_E2E_2026_02_24.md` | `in-progress` (`mitigation-phase`) | `docs/process/TODO_PGM26A1_MITIGASI_GAP_PAGINATION_2026_03_02.md` (`child-spec:in-progress`) | Baseline concern ada di `UI_PAGINATION_E2E`; mitigasi gap implementasi aktif dilacak di `PGM26A1`. |
