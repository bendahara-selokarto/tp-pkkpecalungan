...
| `C-ROLE-BASED-GROUPING` | Penataan ulang grouping modul berdasarkan role user | `docs/process/TODO_RGM26A1_PENATAAN_ULANG_GROUPING_MODUL_BERDASARKAN_ROLE_USER_2026_03_07.md` | `in-progress` | Concern ini dipakai untuk validasi rule grouping berbasis role sebelum merge ke concern parent E2E. |
| `C-ADMIN-BOOK-CATEGORY` | Planning implementasi kategori buku administrasi | `docs/process/TODO_BKADM1_PLANNING_IMPLEMENTASI_KATEGORI_BUKU_ADMINISTRASI_2026_05_20.md` | `planned` | Concern ini mengunci revisi owner 2026-05-20 untuk kategori buku wajib, buku pembantu, dan penunjang buku wajib Sekretaris. |
...
| `C-PDF-DOMPDF-REFACTOR` | Refactoring laporan PDF sesuai standar DomPDF | `docs/process/TODO_PDF26R1_REFACTORING_LAPORAN_PDF_STANDAR_DOMPDF_2026_06_01.md` | `done` | Refactoring menyeluruh template PDF agar patuh pada standar rendering DomPDF (colgroup, auto-layout). |
| `C-PDF-METADATA-FOOTER` | Standarisasi Metadata Cetak (Fixed Footer) | `docs/process/TODO_PDF26F3_STANDARISASI_METADATA_CETAK_FIXED_FOOTER_2026_06_01.md` | `planned` | Standarisasi blok "Dicetak oleh" menggunakan position fixed di batas bawah kertas pada seluruh laporan PDF. |
