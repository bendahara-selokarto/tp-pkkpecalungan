...
| `C-BUDGET-YEAR-CONTEXT` | Refactor isolasi tahun anggaran lintas modul | `docs/process/TODO_TAG26A1_REFACTOR_ISOLASI_TAHUN_ANGGARAN_LINTAS_MODUL_2026_03_07.md` | `in-progress` (`state:wave2-data-keluarga-slice-implemented`) | Concern ini menjadi jalur resmi refactor besar `tahun_anggaran` tanpa mengubah concern existing. |
