...
| `C-SIDEBAR-UI` | Penataan menu/sidebar UI eksperimen | `docs/process/TODO_UI_MENU_VISIBILITY_ALIGNMENT_2026_02_25.md` | `done` (`rolling`) | `TODO_UI_VISIBILITY_BY_PENANGGUNGJAWAB.md`, `TODO_REFACTOR_DASHBOARD_LINTAS_ROLE_2026_02_24.md` | Untuk urutan/group/label sidebar: hanya ikuti `UVM25R1`. |
