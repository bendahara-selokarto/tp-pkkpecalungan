...
| `C-BUKU-ADMIN` | Ketersediaan dan autentik buku administrasi PKK | `docs/process/TODO_KETERSEDIAAN_BUKU_ADMIN_PKK_2026_02_27.md` | `in-progress` (`state:availability-auth-hardening`) | `docs/process/TODO_AUTENTIK_SEKRETARIS_INTI_2026_02_27.md` (`child-spec:in-progress`) | Concern ketersediaan buku diposisikan sebagai parent; autentik sekretaris inti dipertahankan sebagai sub-concern blocker untuk status `verified`. |
